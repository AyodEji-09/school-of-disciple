...
import { Card, Chip, FormControl, FormLabel, Option, Select, Stack, Typography, Box } from "@mui/joy";
...
const RegistrationWindowPage = () => {
  ...
  const openCreateModal = () => {
    const currentSession = (sessions as any[]).find((s) => s.isCurrent);
    setMode("create");
            ...
            {status.label === "Upcoming" && (
              ...
              >
                <Typography level="body-sm" sx={{ color: "#92400E" }}>
                  ⏳ This window hasn't opened yet. Edit it to adjust the dates.
                  A new window cannot be created while one is already scheduled.
                </Typography>
              </Box>
            )}
          </Card>
